...
const LoginPage = () => {
  ...
  //after completing the authContext...
  ...
  const onSubmitHandler = (event) =>{
    ...
    //if calls login function
    //we are creating account or login 
  ...
  return (
    ...
    justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      flex-col gap-6 rounded-1g shadow-lg'>

        <h2 className='font-medium text-2xl flex justify-between items-center'>
          {currentState}
          {isDataSubmitted && <img onClick={()=>setIsDataSubmitted(false)} src={assets.arrow_icon} alt='' className='w-5 cursor-pointer'></img>}
        </h2>
        ...
        {!isDataSubmitted && (
          <>
            {/* why target.value because of for set for next time */}
        ...
        <div className='flex flex-col gap-2'>
          {currentState === "Sign up" ? (
            ...
            <p className='text-sm text-gray-600'>Create an account <span  onClick={() => {setCurrentState("Sign up")}}
